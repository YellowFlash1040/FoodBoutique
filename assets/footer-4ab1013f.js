import{a as i}from"./vendor-bb737cb9.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))c(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&c(r)}).observe(document,{childList:!0,subtree:!0});function n(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function c(t){if(t.ep)return;t.ep=!0;const o=n(t);fetch(t.href,o)}})();a()||u();function a(){return JSON.parse(localStorage.getItem("in-cart"))}function u(e=[]){localStorage.setItem("in-cart",JSON.stringify(e))}function q(e){const s=a();s.includes(e)||u([...s,e])}function P(){u([])}function S(e){const s=a();u(s.filter(n=>n!==e))}function C(){const e=document.getElementById("cart-quantity");e&&(e.innerText=`cart (${a().length})`);const s=document.getElementById("cart-quantity-title");s&&(s.innerText=`cart (${a().length})`)}i.defaults.baseURL="https://food-boutique.b.goit.study/api/";function L(e){return i.get("products",{params:e})}async function M(){return(await i.get("products/categories")).data}async function O(e){return(await i.get(`products/${e}`)).data}const W="/FoodBoutique/images/svg/icons.svg",l="/images/png/vegetables-basket-phone.png",g="/images/png/vegetables-basket-phone@2x.png",p="/images/png/vegetables-basket-tablet.png",m="/images/png/vegetables-basket-tablet@2x.png",f="",h="/images/svg/icons.svg#icon-close";function b(){return`
    <div class="footer-modal-window">
        ...
        <picture>
            <source srcset="${l}, ${g} 2x">

            <source media="(min-width: 768px)" srcset="${p}, ${m} 2x">
  
            <img class="image" src="${l}" alt="${f}" width="335" height="144"/>
        </picture>
